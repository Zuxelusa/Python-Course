...
print(f"For X,Y,X values are 'True, True, False' accordingly the formula returns: {CheckTheFormula(False, True, True)}.")
print(f"For X,Y,X values are 'True, True, False' accordingly the formula returns: {CheckTheFormula(False, False, True)}.")
print(f"For X,Y,X values are 'True, True, False' accordingly the formula returns: {CheckTheFormula(True, False, True)}.")
print(f"For X,Y,X values are 'True, True, False' accordingly the formula returns: {CheckTheFormula(False, True, False)}.")